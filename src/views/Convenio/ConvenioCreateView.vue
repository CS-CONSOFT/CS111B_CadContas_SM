<template>
    <v-container fluid>
        <v-toolbar title="Criar Convênio" class="rounded-lg" style="background-color: transparent">
    ...
    if (formRef.value && formRef.value.validate()) {
        ...
        try {
            ...
            if (response.data.Out_IsSuccess) {
                ...
                showSnackbar(response.data.Out_Message || 'Erro ao salvar convênio', 'error');
            }
        } catch (error) {
